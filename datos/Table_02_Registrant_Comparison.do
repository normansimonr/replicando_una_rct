/* Program to create Table_02: Comparison of Students Registered for the Lottery */
...
set more off;
capture log close;
log using Table_02_Registrant_Comparison.log, replace text;
...
sort row_num;
outsheet col0 col1-col8 using Table_02_Registrant_Comparison.csv if _n <= `row'+1, replace comma;
log close;
